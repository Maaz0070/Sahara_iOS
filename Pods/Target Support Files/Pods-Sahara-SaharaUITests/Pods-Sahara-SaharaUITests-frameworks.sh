...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/BitcoinCashKit.swift/BitcoinCashKit.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/BlsKit.swift/BlsKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/BoringSSL-GRPC/openssl_grpc.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/DashKit.swift/DashKit.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/X11Kit.swift/X11Kit.framework"
